...
/// Default timeout for the UDP sockets in [`QueryClient`](crate::query::blocking::QueryClient)
...
impl Token {
    ...
    ///
    /// ```rust
    /// # use minecraft_server_status::query::Token;
...
impl BasicStat {
    ...
    ///
    /// ```rust
    /// # use minecraft_server_status::query::BasicStat;
...
impl FullStat {
    ...
    ///
    /// ```rust
    /// # use minecraft_server_status::query::FullStat;
    /// let payload = b"...........\
